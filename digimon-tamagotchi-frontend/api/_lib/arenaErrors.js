...
const ARENA_ERROR_STATUS = Object.freeze({
  ...
  ARENA_REALTIME_BATTLE_NOT_FOUND: 404,
  ARENA_REALTIME_FORBIDDEN: 403,
  ARENA_REALTIME_LOBBY_FULL: 409,
  ARENA_REALTIME_STATE_CONFLICT: 409,
  ARENA_REALTIME_ACTION_MISMATCH: 409,
  ARENA_REALTIME_TIMEOUT_NOT_REACHED: 409,
  ARENA_REALTIME_STAGE_INELIGIBLE: 422,
  ARENA_REALTIME_STAGE_MISMATCH: 422,
  ARENA_REALTIME_INVARIANT_VIOLATION: 500,
  JOGRESS_ALREADY_REGISTERED: 409,
  JOGRESS_ROOM_LIMIT_REACHED: 409,
  JOGRESS_STATE_CONFLICT: 409,
  JOGRESS_PAIR_INVALID: 422,
  JOGRESS_FORBIDDEN: 403,
  JOGRESS_ROOM_NOT_FOUND: 404,
});
