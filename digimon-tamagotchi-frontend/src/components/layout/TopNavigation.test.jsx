...
jest.mock("../OnlineUsersCount", () => () => <div data-testid="topnav-chat">채팅 1명</div>);
...
describe("TopNavigation", () => {
  ...
  test("로그인 상태에서는 게임형 채팅과 알림을 계정 메뉴 왼쪽에 순서대로 렌더링한다", () => {
    ...
    const actions = screen.getByTestId("topnav-chat").parentElement?.parentElement;

    expect(actions).toHaveTextContent("채팅 1명알림:inline");
