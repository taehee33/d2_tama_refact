...
function CommunityPostCard({
  ...
  return (
    <article className={`service-card community-post-card${isActive ? " community-post-card--active" : ""}`}>
      ...
      <div className="community-snapshot-chip-list">
        ...
        <span className="community-snapshot-chip">{snapshot.digimonDisplayName || "디지몬"}</span>
